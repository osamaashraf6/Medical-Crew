...
function Treatments() {
  const Treatmentss = [
    {
      icon: "fas fa-syringe", // أيقونة التطعيمات
    ...
    {
      icon: "fas fa-first-aid", // أيقونة للإسعافات الأولية
    ...
    {
      icon: "fas fa-heartbeat", // أيقونة الأمراض المزمنة
    ...
    {
      icon: "fas fa-child", // أيقونة لفحوصات التطور
    ...
    {
      icon: "fas fa-tshirt", // أيقونة الملابس
