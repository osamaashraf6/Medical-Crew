...
function Departments() {
  return (
    <div className="">
      <Hero_about
        title="Get to Know ProHealth Departments"
        description="At ProHealth, we offer a wide range of medical and healthcare services that are designed to meet your individual needs and help you achieve optimal health."
        img={hero}
        reverseLayout={true}
      />
