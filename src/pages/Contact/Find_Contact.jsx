function Find_Contact() {
  return (
    <div className="mb-[80px]">
      ...
      <h1 className="py-5 text-3xl font-bold text-text_color">Find Us Here</h1>

        <div className="flex flex-col justify-between gap-7 md:gap-20 md:flex-row">
          <div className="flex items-center gap-4 py-3 rounded-[10px] bg-[#D2EAEF] text-secondary w-full px-4">
